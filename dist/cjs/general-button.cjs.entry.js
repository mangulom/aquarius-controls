...
const GeneralButton = class {
    ...
    render() {
        return (index.h("button", { key: '79cbfe72e6c019c32655d90a933f169c89163fa3', disabled: this.disabled, class: "general-button" }, this.icon && index.h("i", { key: '277c90407ccfdc922113dc7d5597410d80043f78', class: this.icon }), index.h("span", { key: 'ea5d96cf89a97b01c920e510c4c25610aa47753d' }, this.label)));
    }
};
