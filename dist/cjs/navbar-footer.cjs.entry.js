...
const NavbarFooter = class {
    ...
    render() {
        return (index.h("footer", { key: '7750ed4e2de3294d6ba7e3beeb6624e47ec9b8b7', class: "navbar-footer" }, index.h("div", { key: '0d3507d132f87a69c6f9ff1ae118c34503739b59', class: "navbar-buttons" }, this.items.map((item, index$1) => (index.h("div", { class: "nav-item-wrapper", key: index$1 }, index.h("button", { class: "nav-item", onClick: () => item.route ? this.handleClick(item.route) : this.toggleDropdown(index$1) }, item.icon && index.h("i", { class: item.icon }), index.h("span", null, item.label)), item.subitems && (index.h("div", { class: { 'subitems-container': true, 'open': this.openIndex === index$1 } }, item.subitems.map((sub, subIndex) => (index.h("button", { class: "subitem", key: subIndex, onClick: () => this.handleClick(sub.route) }, sub.icon && index.h("i", { class: sub.icon }), index.h("span", null, sub.label))))))))))));
    }
};
