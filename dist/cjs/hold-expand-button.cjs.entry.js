...
const HoldExpandButton = class {
    ...
    render() {
        return (index.h("button", { key: 'b4da737a480cf2a3f7f4e9f0d4b135f1a188fb15', class: {
                'hold-btn': true,
                'expanded': this.expanded
            }, disabled: this.disabled, onMouseDown: this.startHold, onMouseUp: this.endHold, onMouseLeave: this.endHold, onTouchStart: this.startHold, onTouchEnd: this.endHold }, index.h("i", { key: 'b390cfb880ce25db315bed0f304e5d5a6522b1ce', class: this.icon }), index.h("span", { key: '9b7040dcb2d146aed1089588a413b6d551ca6b26', class: "label" }, this.label)));
    }
};
