...
const HoldExpandButton = class {
    ...
    render() {
        ...
        return (index.h("button", { key: '02a00c1a2215233b51f1cf3aab2b50d7dfe6c9d6', disabled: this.disabled, class: `hold-button ${colorClass} ${this.expanded ? 'expanded' : ''}`, onMouseDown: this.startHold, onMouseUp: this.endHold, onMouseLeave: this.endHold, onTouchStart: this.startHold, onTouchEnd: this.endHold }, index.h("div", { key: 'c9b5b19a82e83d949d1d083027390ee1315fb135', class: "content" }, this.icon && index.h("i", { key: '8229c1cd6ed240c5db758d520459e7ac64ffc72d', class: this.icon }), index.h("span", { key: '3c4400fdc47f965f707ee500112dbf6d0f2058d6', class: "label" }, this.label))));
    }
};
