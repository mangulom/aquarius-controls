...
const HoldExpandButton = class {
    ...
    render() {
        ...
        return (index.h("button", { key: '23175cd3dbffb7948acfab85ebbdaa162b396be1', disabled: this.disabled, class: `hold-button ${colorClass} ${this.expanded ? 'expanded' : ''}`, onMouseDown: this.startHold, onMouseUp: this.endHold, onMouseLeave: this.endHold, onTouchStart: this.startHold, onTouchEnd: this.endHold }, index.h("div", { key: '1a464119de9c9181c77d6543db25766c8b915a9c', class: "center" }, this.icon && index.h("i", { key: 'ff3ccee7ce7af4702f31a04a489c30c657e3230c', class: this.icon }), index.h("span", { key: '06a241b2a316e857233101e1be59254b7af64283', class: "label" }, this.label))));
    }
};
