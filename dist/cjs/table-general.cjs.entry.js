...
const TableGeneral = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '11890a81eab8ed0e088cde64bb6f8d58b300494e', class: "table-responsive" }, index.h("table", { key: '2db05a13cfc7dc46d50b38d059eb514c07cc5289', class: "styled-table" }, index.h("thead", { key: 'a3608a7c31218d218f29b89425fc9c07b116b507' }, index.h("tr", { key: 'c7d6add0734d2f6beeae85d7debaf4a7984cf7cc' }, columnsArr.map(col => (index.h("th", { class: col.color ? `th-${col.color.toLowerCase()}` : '', onClick: () => this.sortByColumn(col.key) }, col.label, this.sortKey === col.key && (index.h("span", { class: "sort-indicator" }, this.sortAsc ? ' ▲' : ' ▼'))))))), index.h("tbody", { key: 'a3059ce718da497084b332430362c1da342ae6a6' }, this.sortedData.map(row => (index.h("tr", null, columnsArr.map(col => (index.h("td", null, row[col.key]))))))))));
    }
