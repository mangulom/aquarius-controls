...
patchBrowser().then(async (options) => {
  ...
  return index.bootstrapLazy([["general-button.cjs",[[512,"general-button",{"label":[1],"disabled":[4],"icon":[1]}]]],["navbar-footer.cjs",[[512,"navbar-footer",{"items":[16]}]]],["navbar-horizontal.cjs",[[512,"navbar-horizontal",{"items":[16],"openIndex":[32]}]]]], options);
});
