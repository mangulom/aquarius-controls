...
const DonutRadio = class {
    ...
    render() {
        return (index.h("label", { key: 'ccefbe8550f028da213cecee7164354cc1aa022f', class: {
                'donut-radio': true,
                'disabled': this.disabled
            } }, index.h("input", { key: 'ae29aa854a441d28826e49cfb87eb5bc9f75d95a', type: "radio", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, color: this.color, onChange: this.onChange }), index.h("span", { key: '1ad5badc2eb135f8200bb63f7d5891c6d7b163b3', class: "control" }), this.label && index.h("span", { key: '3c4a49673ed508acb35311229754183bb2e658d9', class: "text" }, this.label)));
    }
};
