...
const DonutRadio = class {
    ...
    render() {
        return (index.h("label", { key: '0c846b7790877b310e1f81c87be20b6e55cef3cd', class: "radio" }, index.h("input", { key: 'd7c8757409a29a5c77972168c8c1df96c1a4a0d9', type: "radio", checked: this.checked, onClick: this.onClick, color: this.color }), index.h("span", { key: 'db2d125ef8d471e4eccff5ed753cc15ffd929e73', class: "control" }), index.h("span", { key: '1a6a48c414a8f7b01e3b738775ceff0e971ca8d0', class: "label" }, this.label)));
    }
};
