...
const DonutRadio = class {
    ...
    render() {
        return (index.h("label", { key: '7ae155c6e2d4b1cac9dec98ce284b8624edb652a', class: {
            ...
            } }, index.h("input", { key: 'e15efba402243fb42c303e06144e99d960dcc517', type: "radio", name: this.name, value: this.value, defaultChecked: this.checked, disabled: this.disabled, color: this.color }), index.h("span", { key: 'f39152a4b5fa613765fd925e5c3fd2530e90649f', class: "control" }), this.label && index.h("span", { key: '153aaf89dedd23708be7df968dffd7490431b415', class: "text" }, this.label)));
    }
};
