...
const NavbarHorizontal = class {
    ...
    render() {
        return (index.h("nav", { key: '8ee58aa53b8d61ff00454f1a757dcf81e8ef96a3', class: "navbar" }, this.items.map((item, index$1) => (index.h("div", { class: "nav-item-wrapper" }, index.h("button", { class: "nav-item", onClick: () => this.toggleDropdown(index$1) }, item.icon && index.h("i", { class: item.icon }), index.h("span", null, item.label)), item.subitems && this.openIndex === index$1 && (index.h("div", { class: "subitems" }, item.subitems.map(sub => (index.h("button", { class: "subitem" }, sub.icon && index.h("i", { class: sub.icon }), index.h("span", null, sub.label)))))))))));
    }
};
